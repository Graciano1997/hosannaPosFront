            ...
            <Modal helper={stopExporting}>
                <form className='flex flex-col h-[100%]  mt-[1rem] rounded p-3 overflow-y-auto'>
                    ...
                    <div className="flex flex-col gap-[-2rem]">
                        ...
                        {exportOption == "pdf" && <div className="grid grid-cols-2 gap-5">
                            <label>
                                <br />
                                {firstCapitalize(t('orientation'))}
                                <select name="orientation" onChange={pdfPageHandlerSetting} className='p-2 rounded w-[100%] outline-none' id="">
                            ...
                            <label>
                                <br />
                                {firstCapitalize(t('pdf_page_size'))}
                                <select name="size" onChange={pdfPageHandlerSetting} className='p-2 rounded w-[100%] outline-none' id="">
