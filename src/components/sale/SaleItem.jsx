...
const SaleItem = React.memo(
    ...
    return(
        <div className={`grid grid-cols-[20fr_20fr_20fr_20fr_20fr] md:grid-cols-[10fr_10fr_10fr_10fr_10fr_25fr_10fr] place-items-center text-md ${index%2==0?'bg-primary':'bg-green-50'} p-3 cursor-pointer`}>
                <p>{product.name}</p>
