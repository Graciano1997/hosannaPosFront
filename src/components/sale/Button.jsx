        ...
        <div className="absolute bottom-[20px] pr-3  w-[100%] flex justify-end">
            {
              (
               ...
               &&
                (
                (saleState.invoiceType == SaleType.PROFORM_PF || saleState.invoiceType == SaleType.NORMAL_INVOICE_FT) 
                ||
                (
                ...
                && saleState.receivedCash * 1 >= saleState.total * 1 
                || saleState.paymentType == PaymentType.MIXED 
                && ((saleState.receivedCash * 1 + saleState.receivedTpa * 1) >= saleState.total * 1) 
            ...
            (
            saleState.invoiceType==SaleType.RECEIPT_RC
            && (saleState.newAmountToReceiveForTheFTInvoice > 0 && saleState.newAmountToReceiveForTheFTInvoice <= (saleState.total - saleState.receivedCash ))
            &&
