...
const Dashboard=()=>{
    ...
    return(
        ...
        <Card className="font-black" width={400} height={350} info={{title: firstCapitalize(t('today_balance')),description:<Money amount={3000}/>}} />
        <Card className="font-black" width={400} height={350}   info={{output:true,title:firstCapitalize(t('spents')),description:<Money amount={4000}/>}} />
