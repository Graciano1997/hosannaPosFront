...
const anualExpired = productState.anualExpireds || [];
    ...
    const today_balance = sales.length > 0 ? totalToDay(sales, new Date()) : 0;
    const today_spents = spentState.spents && spentState.spents.length > 0 ? totalToDay(spentState.spents, new Date(), "amount") : 0;
